#ifndef INITSOLUTIONM1_H
#define INITSOLUTIONM1_H
#include <vector>
#include <iostream>
...
class InitSolutionM1
{
 public:
        //InitSolution();
        //InitSolution(int dayScan, vector<int> &bookScoresList, vector<Library> &libs);
        InitSolutionM1(int dayScan, vector<int> &bookScoresList, vector<Library> &libs);
        virtual ~InitSolutionM1();
